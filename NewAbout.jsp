  ...
  <div class="header">
    ...
    <nav>
        <ul>
          ...
          <li class="active"><a href="NewAbout.jsp">About Us</a></li>
    ...
    <div class="content_resize">
      <div class="mainbar" >
        <div class="article">
          ...
          <div class="clr"></div>
          <p align="justify"><strong>This project provides marketplace for Small &amp; Medium Size Businesses, connecting global buyers with Customers. The project offers a platform  tool to over  millions of suppliers to generate business leads from over billions of customers, who use the platform to find reliable &amp; competitive products.</strong></p>
